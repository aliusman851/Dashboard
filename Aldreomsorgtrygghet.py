...
def show():
   ...
   if api_url:
        ...
        if data:
            ...
            fig = px._chart_types.ecdf(df_ar, x='ar', y=['hemtjansttrygghet_kvinnor', 'hemtjansttrygghet_man', 'hemtjansttrygghet_totalt'], title='Brukarbedömning hemtjänst äldreomsorg-trygghet, andel(%)')
            st.plotly_chart(fig)
            output = BytesIO()
